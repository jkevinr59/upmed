...
<head>
	...
	<link rel="stylesheet" type="text/css" href="public/css/login-old.css">
...
<body class='login-bg'>
    ...
    <div class="row" style="height: 200px;"><img src="public/images/big-logo.png" style="position:absolute;left:70%;top=20%;"></div>
	...
	<script src="public/js/login-old.js"></script>
</body>
</html>